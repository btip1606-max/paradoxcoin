Contributing to paradoxcoin Core
============================

The paradoxcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the paradoxcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/paradoxcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to paradoxcoin-qt
...
The following applies to code changes to the paradoxcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall paradoxcoin
Network Protocol consensus changes.

Whether a pull request is merged into paradoxcoin Core rests with the project merge
...
Patches that change paradoxcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the paradoxcoin consensus, it must have been
...
The project leader is the release manager for each paradoxcoin Core release.
