...
bech32_templates = [
  ...
  ('PAR',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('PAR',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('PAR',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('PAR',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tPAR',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tPAR',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tPAR',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tPAR',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tPAR',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tPAR',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tPAR',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tPAR',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rPAR',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rPAR',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rPAR',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rPAR', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tPAR',   17, 32, Encoding.BECH32M, False, False, False),
  ('rPAR',  3,  1, Encoding.BECH32M, False, False, False),
  ('PAR',   15, 41, Encoding.BECH32M, False, False, False),
  ('tPAR',    0, 16, Encoding.BECH32,  False, False, False),
  ('rPAR',  0, 32, Encoding.BECH32,  True,  False, False),
  ('PAR',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tPAR',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rPAR',  0, 20, Encoding.BECH32,  False, False, True),
  ('PAR',    0, 20, Encoding.BECH32M, False, False, False),
  ('tPAR',    0, 32, Encoding.BECH32M, False, False, False),
  ('rPAR',  0, 20, Encoding.BECH32M, False, False, False),
  ('PAR',    1, 32, Encoding.BECH32,  False, False, False),
  ('tPAR',    2, 16, Encoding.BECH32,  False, False, False),
  ('rPAR', 16, 20, Encoding.BECH32,  False, False, False),
]
