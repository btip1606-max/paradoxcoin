/* src/config/paradox-config.h.  Generated from paradox-config.h.in by configure.  */
/* src/config/paradox-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef paradox_CONFIG_H

#define paradox_CONFIG_H
