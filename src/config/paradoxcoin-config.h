/* src/config/paradoxcoin-config.h.  Generated from paradoxcoin-config.h.in by configure.  */
/* src/config/paradoxcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PARADOXCOIN_CONFIG_H

#define PARADOXCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The ParadoxCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "ParadoxCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/paradoxcoin-project/paradoxcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ParadoxCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ParadoxCoin Core 0.21.5.6"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "paradoxcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://paradoxcoin.org/"
