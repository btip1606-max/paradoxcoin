...
static void SetupparadoxTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " paradoxcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  paradoxcoin-tx [options] <hex-tx> [commands]  Update hex-encoded paradoxcoin transaction\n" +
            "or:     paradoxcoin-tx [options] -create [commands]   Create hex-encoded paradoxcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded paradox transaction
