...
"""Verify that starting paradoxcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start paradoxcoin with -h for help text")
        ...
        self.log.info("Start paradoxcoin with -version for version information")
        ...
        self.log.info("Start paradoxcoind with -fakearg to make sure it does not start")
