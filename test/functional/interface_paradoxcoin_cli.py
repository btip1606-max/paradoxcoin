#!/usr/bin/env python3
# Copyright (c) 2017-2020 The paradox Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test paradox-cli"""

from decimal import Decimal
from test_framework.test_framework import paradoxTestFramework
...
# The block reward of coinbaseoutput.nValue (50) PAR/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 PAR/block.
BLOCKS = 101
...
class TestparadoxCli(paradoxTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `paradoxcoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and paradox-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 PAR) to the default wallet.
            ...
            # Test paradox-cli -generate with -rpcwallet in multiwallet mode.
