#!/usr/bin/env python3
# Copyright (c) 2014-2022 The ParadoxCoin Core developers
...
from test_framework.par_util import make_utxo
from test_framework.script_util import DUMMY_P2WPKH_SCRIPT


class parReplaceByFeeTest(paradoxTestFramework):
